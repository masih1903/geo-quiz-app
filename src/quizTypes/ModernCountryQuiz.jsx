...
function ModernCountryQuiz({ continent, apiUrl, title }) {
  ...
  const handleOptionClick = (selectedCapital) => {
    ...
    if (selectedCapital === currentCountry.capital[0]) {
      // Correct answer
      ...
      <Header>
        ...
        <Subtitle>
          {gameStarted && !gameCompleted
            ...
            : `Test your knowledge of ${continent} countries and capitals!`}
        </Subtitle>
      </Header>
          ...
          {!gameStarted ? (
            <div style={{ textAlign: 'center', padding: 'var(--space-8)' }}>
              ...
              <p style={{ marginBottom: 'var(--space-8)', color: 'var(--gray-600)', fontSize: 'var(--text-lg)' }}>
                You'll be shown countries from {continent} and need to identify their capitals.
            ...
            <>
              {currentCountry && !gameCompleted && (
                <QuestionSection>
                  <QuestionText>What is the capital of this country?</QuestionText>
                  <CountryDisplay>{currentCountry.name.common}</CountryDisplay>
              ...
              <OptionsGrid>
                {options.map((capital, index) => {
                  const shouldShake = shakeCard === capital;
      ...
      {showCompletionModal && (
        <CompletionModal onClick={() => setShowCompletionModal(false)}>
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <ModalText>
              Outstanding! You've completed the {continent} countries quiz.
              <br />
...
export default ModernCountryQuiz;
